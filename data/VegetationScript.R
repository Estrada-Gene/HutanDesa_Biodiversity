######### vegetation indices for Hutan Desa (HD) sites ###########
setwd("~/HutanDesa_Biodiversity/data")
...
#it looks like every plant except 34 was ID'd to the species level
table(is.na(v$Species))

#only one did not have an ID to the genus level
table(is.na(v$Genus))
